      ...
      {isMoreMenuOpen && (
        <>
          ...
          <div className="more-menu-container">
            <Link href="/stats" className="more-menu-item" onClick={() => setIsMoreMenuOpen(false)}>
            ...
            <Link href="/galaxy" className="more-menu-item" onClick={() => setIsMoreMenuOpen(false)}>
            ...
            <Link href="/kindle" className="more-menu-item" onClick={() => setIsMoreMenuOpen(false)}>
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v16a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2z"/><path d="M9 22v-4h6v4"/><path d="M8 6h8"/><path d="M8 10h5"/></svg>
              Kindle Sync
            </Link>
            <div className="more-menu-divider" />
            <Link href="/settings" className="more-menu-item" onClick={() => setIsMoreMenuOpen(false)}>
